...
fly_surface = pygame.image.load("assets/enemies/superman0.png").convert_alpha()
...
while is_main_loop_running:
    ...
    # GAME OVER SCREEN if current game not active
        ...
        player_rectangle.midbottom = (50, 400)  # put player back to original start pos (e.g. was jumping at gameover)
        player_gravity = 0
